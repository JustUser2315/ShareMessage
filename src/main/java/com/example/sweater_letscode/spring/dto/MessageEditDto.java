...
public class MessageEditDto {
    ...
    @NotBlank(message = "The text is  blank or empty. Please try again with a valid text entry that meets these requirements.")
//    @NotEmpty(message = "Sorry, the text you entered does not meet the required format. The text is  blank or empty. Please try again with a valid text entry that meets these requirements.")
    private String text;
    @Size(min = 3, max = 25, message = "Sorry, the text you entered does not meet the required format. The tag must contain at least 3 characters. Please try again with a valid tag entry that meets these requirements.")
    @NotBlank(message = "The tag is  blank or empty. Please try again with a valid tag entry that meets these requirements.")
//    @NotEmpty(message = "Sorry, the text you entered does not meet the required format. The text is  blank or empty. Please try again with a valid text entry that meets these requirements.")
    private String tag;
